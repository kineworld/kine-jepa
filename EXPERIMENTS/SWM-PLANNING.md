...
| 方案 | 中位 d2 | 中位改善 | 中位耗时 s | 返回动作峰值 | 既有断言 |
| --- | ---: | ---: | ---: | ---: | --- |
| `kinejepa_unbounded` | 0.2121 | 87.61× | 0.937 | 2.333 | PASS |
| `swm_cem_free` | 0.9572 | 27.04× | 0.625 | 1.895 | PASS |
| `swm_mppi_free` | 0.5268 | 57.88× | 0.628 | 1.840 | PASS |
| `swm_icem_free` | 0.2008 | 118.60× | 0.699 | 3.716 | PASS |
| `swm_predictive_free` | 6.5560 | 3.95× | 0.087 | 2.428 | mixed |
| `swm_cem_default` | 0.0061 | 1990.28× | 5.378 | 2.999 | PASS |
...
| `swm_cem_boxed` | 8.4617 | 4.24× | 0.637 | 1.000 | mixed |
| `swm_mppi_boxed` | 6.4978 | 7.33× | 0.730 | 1.000 | PASS |
| `swm_icem_boxed` | 7.2166 | 6.60× | 0.750 | 0.997 | mixed |
| `swm_predictive_boxed` | 11.7091 | 2.21× | 0.081 | 1.000 | mixed |
