...
> 勘境 Kineworld 的第一个公开实验，也是 KineOne-WM-Latent 0.1 的历史训练记录。所有配置、数据配方与指标随仓库公开，可被任何人复核或复现。
...
| 项 | 值 |
|---|---|
| 架构 | KineOne-WM-Latent（历史代号 KINE-JEPA）：ViT-S/16 tubelet(2×16×16) 编码器 + EMA 目标编码器 + 预测器 |
