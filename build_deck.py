...
<section>
  <h2><span class="n">4</span>差异化矩阵（vs 白泽类基线）</h2>
...
<section>
  <h2><span class="n">5</span>开源 / 闭源边界（护城河）</h2>
...
<section>
  <h2><span class="n">6</span>路线图（到物理可信 KineOne-WM）</h2>
  <div class="steps">
...
<section>
  <h2><span class="n">7</span>申报节点</h2>
  <div class="filing">
